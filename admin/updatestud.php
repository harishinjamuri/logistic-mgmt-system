...
Name='".$studname."',Father_Name= '".$Fname."',Department_Name='".$department."',Mobile_Number= '".$mobile."',Course='".$Course."',Year='".$Year."',Total='".$total."',Due='".$due."',Boarding_point='".$boardingpoint."',Route_no='".$routeno."',Detain='".$detain."',Receipt_Number='".$receipt."',Remarks='".$remarks."',acadyear='".$ay."',Verifiedby='".$usr."' WHERE HallticketNumber = '".$hallticket3."'";
}
else
...
<div class="col-lg-4">
  <div class="form-group">
    ...
    <input type="text" class="form-control" pattern="[6789][0-9]{9}" title="Phone number starting with 6-9 and remaining 9 digit with 0-9" id="mobile"  value="<?php echo $row['Mobile_Number'];?>" name="mobile" placeholder="Enter Mobile No" required>
...
{  
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="remarks"  value="<?php echo $row['Remarks'];?>" name="remarks" maxlength="50" aria-describedby="Name" placeholder="Remarks" required>
