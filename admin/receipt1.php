...
<p align="right" style="width: 680px"><b>OFFICE COPY</b></p>
...
<tr>
<td align="center"><b>STUDENT BUS PASS RECEIPT <?php echo $row['acadyear'];?></b></td>
</tr>
...
<tr>
				...
				<td >Receipt date  </td>
				<td width="100px"><p><?php echo date("d/m/Y");?></p></td>
</tr>
            ...
            <tr style="vertical-align: baseline;line-height: 1;">
				...
				<td style="width:100px;">Course & Branch </td>
				<td  ><p><?php echo $row['Year']."   ".$row['Course']."   ".$row['Department_Name'];?></p></td>
			</tr>
			<tr >
				...
				<td rowspan="4" style="margin:0px;padding:0px 50px 5px 0px;"><img src="<?php 
				...
				<td  rowspan="5" id="blah" style="padding:8px;"><img  <?php echo 'src="img/'.$row['imageofStudent'].'';?>" alt="yourimage" class="auto-style2" style="height:115px;width:100px;margin:0;padding:0;"/></td>
				</tr>
				<tr >
...
<td ><p><?php echo $row['Total']; ?></p></td><td></td>
</tr><tr style="margin-bottom:10px;">
				<td style="margin:0;vertical-align: baseline;line-height: 1;padding-left:10px;">Due  </td>
<td style="margin:0;vertical-align: baseline;line-height: 1;"><p><?php echo $row['Due']; ?></p></td><td></td><td></td>
			</tr>
<tr>
<td colspan="4" >
...
<br/>
<hr style="border-style:dashed;height:1px;color:#000;width:88%;" />


  
<p align="right" style="width: 680px"><b>STUDENT COPY</b></p>
...
<tr>
			...
			<tr >
				...
				<td style="vertical-align: baseline;line-height: 1;"  width="180px"><p><?php echo $row['Name'];?></p></td>
				<td rowspan="4" style="margin:0px;padding:0px 50px 5px 0px;"><img src="<?php 
				 $data = "H.T No: ".$row['HallticketNumber']."  Name: ".$row['Name']." Paid:".$row['Total']." Due:".$row['Due'];
				echo "qr_php/qr_img.php?d=$data"; ?>" width="90px" height="90px"></td>
				<td  rowspan="5" id="blah" style="padding:8px;"><img  <?php echo 'src="img/'.$row['imageofStudent'].'';?>" alt="yourimage" class="auto-style2" style="height:115px;width:100px;margin:0;padding:0;"/></td>
				</tr>
				<tr >
...
<td ><p><?php echo $row['Total']; ?></p></td><td></td>
				...
				<td style="margin:0;vertical-align: baseline;line-height: 1;padding-left:10px;">Due  </td>
<td style="margin:0;vertical-align: baseline;line-height: 1;"><p><?php echo $row['Due']; ?></p></td><td></td><td></td><br/>
			</tr>
<tr>
<td colspan="4" >
<table style="margin-top:10px;border-top:2px solid black;" width="680px">
